	...
	public static void main(String[] args) throws Exception {
		...
		String tableName   ="SYS_ROLERIGHT";
			Map createrInfos = new HashMap<String,LabelInfo>(){{
				this.put("ROLEID", new LabelInfo("角色", FormType._201SELECT , SearchType._1SELECT ));//type:int
				this.put("MODULEID", new LabelInfo("模块", FormType._201SELECT , SearchType._1SELECT ));//type:int
				this.put("MODULERIGHT", new LabelInfo("权限", FormType._101TEXT , SearchType._2STRING+SearchType._0NSEARCH ));//type:varchar
			}};
